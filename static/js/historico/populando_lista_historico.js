...
var itensHistorico = document.getElementById('itens_historico');
var listItens = document.getElementById('list_itens_historico');

function carregarItensHistorico() {
    ...
    if (itensCache) {
        ...
        atualizarListaHistorico(JSON.parse(itensCache));
    } else {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                atualizarListaHistorico(data);
            }
        });
    }
}

function atualizarListaHistorico(itens) {
    listItens.innerHTML = '';
...
itensHistorico.addEventListener('click', carregarItensHistorico);
itensHistorico.addEventListener('focus', carregarItensHistorico);
...
configurarDropdown('itens_historico', 'list_itens_historico');
